...
public class Stapel {
    ...
    public static final Image imageA = new Image(Stapel.class.getResourceAsStream("/images/A.png"));
    public static final Image imageB = new Image(Stapel.class.getResourceAsStream("/images/B.png"));
    public static final Image imageC = new Image(Stapel.class.getResourceAsStream("/images/C.png"));
    public static final Image imageD = new Image(Stapel.class.getResourceAsStream("/images/D.png"));
    public static final Image imageE = new Image(Stapel.class.getResourceAsStream("/images/E.png"));
    public static final Image imageF = new Image(Stapel.class.getResourceAsStream("/images/F.png"));
    public static final Image imageG = new Image(Stapel.class.getResourceAsStream("/images/G.png"));
    public static final Image imageH = new Image(Stapel.class.getResourceAsStream("/images/H.png"));
    public static final Image imageI = new Image(Stapel.class.getResourceAsStream("/images/I.png"));
    public static final Image imageJ = new Image(Stapel.class.getResourceAsStream("/images/J.png"));
    public static final Image imageK = new Image(Stapel.class.getResourceAsStream("/images/K.png"));
    public static final Image imageL = new Image(Stapel.class.getResourceAsStream("/images/L.png"));
    public static final Image imageM = new Image(Stapel.class.getResourceAsStream("/images/M.png"));
    public static final Image imageN = new Image(Stapel.class.getResourceAsStream("/images/N.png"));
    public static final Image imageO = new Image(Stapel.class.getResourceAsStream("/images/O.png"));
    public static final Image imageP = new Image(Stapel.class.getResourceAsStream("/images/P.png"));
    public static final Image imageQ = new Image(Stapel.class.getResourceAsStream("/images/Q.png"));
    public static final Image imageR = new Image(Stapel.class.getResourceAsStream("/images/R.png"));
    public static final Image imageS = new Image(Stapel.class.getResourceAsStream("/images/S.png"));
    public static final Image imageT = new Image(Stapel.class.getResourceAsStream("/images/T.png"));
    public static final Image imageU = new Image(Stapel.class.getResourceAsStream("/images/U.png"));
    public static final Image imageV = new Image(Stapel.class.getResourceAsStream("/images/V.png"));
    public static final Image imageW = new Image(Stapel.class.getResourceAsStream("/images/W.png"));
    public static final Image imageX = new Image(Stapel.class.getResourceAsStream("/images/X.png"));

    public static final Image mannBlau = new Image(Stapel.class.getResourceAsStream("/images/Mann_Blau.png"));
    public static final Image mannGelb = new Image(Stapel.class.getResourceAsStream("/images/Mann_Gelb.png"));
    public static final Image mannGruen = new Image(Stapel.class.getResourceAsStream("/images/Mann_Gruen.png"));
    public static final Image mannRot = new Image(Stapel.class.getResourceAsStream("/images/Mann_Rot.png"));
    public static final Image mannSchwarz = new Image(Stapel.class.getResourceAsStream("/images/Mann_Schwarz.png"));

    public static final Image mannBlauHR = new Image(Stapel.class.getResourceAsStream("/images/Mann_Blau_x150.png"));
    public static final Image mannGelbHR = new Image(Stapel.class.getResourceAsStream("/images/Mann_Gelb_x150.png"));
    public static final Image mannGruenHR = new Image(Stapel.class.getResourceAsStream("/images/Mann_Gruen_x150.png"));
    public static final Image mannRotHR = new Image(Stapel.class.getResourceAsStream("/images/Mann_Rot_x150.png"));
    public static final Image mannSchwarzHR = new Image(Stapel.class.getResourceAsStream("/images/Mann_Schwarz_x150.png"));

    public static final Image rotateRight = new Image(Stapel.class.getResourceAsStream("/images/rotate-right.png"));
    public static final Image rotateLeft = new Image(Stapel.class.getResourceAsStream("/images/rotate-left.png"));
    public static final Image surrender = new Image(Stapel.class.getResourceAsStream("/images/white-flag-symbol.png"));
    public static final Image throwCard = new Image(Stapel.class.getResourceAsStream("/images/external-link-symbol.png"));
    public static final Image manual = new Image(Stapel.class.getResourceAsStream("/images/book.png"));
